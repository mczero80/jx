...
#define USHRT_MAX ((1024*64)-1)
#define UINT_MAX ((1024*1024*1024*4)-1)
#define ULONG_MAX ((1024*1024*1024*4)-1)
#define SHRT_MAX ((1024*32)-1)
#define INT_MAX ((1024*1024*1024*2)-1)
#define LONG_MAX ((1024*1024*1024*2)-1)
#endif				/* KERNEL */
#ifdef __cplusplus
extern "C" {
#endif
...
#define lzo_init() __lzo_init2(LZO_VERSION,(int)sizeof(short),(int)sizeof(int),\
    ...
    (int)sizeof(lzo_compress_t))
	 LZO_EXTERN(int) __lzo_init2(unsigned, int, int, int, int, int,
				     int, int, int, int);
...
/* string functions */
	 LZO_EXTERN(int)
	 lzo_memcmp(const lzo_voidp _s1, const lzo_voidp _s2,
		    lzo_uint _len);
...
/* checksum functions */
	 ...
	 lzo_adler32(lzo_uint32 _adler, const lzo_byte * _buf,
		     lzo_uint _len);
	 LZO_EXTERN(lzo_uint32)
...
/* memory allocation functions */
	...
	typedef lzo_bytep(__LZO_ENTRY * lzo_alloc_hook_t) (lzo_uint,
							   lzo_uint);
