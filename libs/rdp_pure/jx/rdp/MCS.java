...
public class MCS {
	...
	if(debug)Debug.out.println("Sending Connect Initial ...");
	this.sendConnectInitial(data);
	if(debug)Debug.out.println("Connect Initial sent");
	if(debug)Debug.out.println("Receiving Connect Response ...");
	this.receiveConnectResponse(data);
	if(debug)Debug.out.println("Connect response received: O.K.");

	if(debug)Debug.out.println("Sending Erect Domain Request ...");
	send_edrq();
	if(debug)Debug.out.println("Erect Domain Request sent");

	if(debug)Debug.out.println("Sending AURQ ...");
	send_aurq();
	if(debug)Debug.out.println("AURQ sent");

	if(debug)Debug.out.println("Receiving AUCF ...");
	this.McsUserID=receive_aucf();
	if(debug)Debug.out.println("AUCF received: O.K.");
	if(debug)Debug.out.println("Sending CJRQ ...");
	send_cjrq(this.McsUserID+1001);
	if(debug)Debug.out.println("CJRQ sent");
	if(debug)Debug.out.println("Receiving CJCF ...");
	receive_cjcf();
	if(debug)Debug.out.println("CJCF received: O.K.");
	if(debug)Debug.out.println("Sending CJRQ ...");
    ...
    public void connect(InetAddress host, Packet data) throws IOException, RdesktopException, SocketException {
