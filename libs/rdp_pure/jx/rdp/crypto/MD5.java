...
//...........................................................................
    ...
    public int engineGetDigestLength() { return HASH_LENGTH; }

    /** Returns the length of the data (in bytes) hashed in every transform. */
    public int engineGetDataLength() { return DATA_LENGTH; }
     ...
     */
    public void engineTransform(byte[] in)
    {
        java_transform(in);
    }
...
//...........................................................................
    ...
    static public int F(int x,int y,int z) { return (z ^ (x & (y^z))); }
    static public int G(int x,int y,int z) { return (y ^ (z & (x^y))); }
    static public int H(int x,int y,int z) { return (x ^ y ^ z); }
    static public int I(int x,int y,int z) { return (y  ^  (x | ~z)); }


    static public int FF(int a,int b,int c,int d,int k,int s,int t)
    {
        a += k+t+F(b,c,d);
        a = (a << s | a >>> -s);
        return a+b;
    ...
    static public int GG(int a,int b,int c,int d,int k,int s,int t)
    {
        a += k+t+G(b,c,d);
        a = (a << s | a >>> -s);
        return a+b;
    ...
    static public int HH(int a,int b,int c,int d,int k,int s,int t)
    {
        a += k+t+H(b,c,d);
        a = (a << s | a >>> -s);
        return a+b;
    ...
    static public int II(int a,int b,int c,int d,int k,int s,int t)
    {
        a += k+t+I(b,c,d);
        a = (a << s | a >>> -s);
        return a+b;
    ...
    public  static void byte2int(byte[] src, int srcOffset,
