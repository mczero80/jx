...
public class HexDump {
	...
	while(count < data.length) {
     ...
     public void encode(int[] data, DebugPrintStream out) {
	int count = 0;
	String index;
	String number;
	...
	while(count < data.length) {
		...
		number = Integer.toHexString(data[count]);
		switch(number.length()) {
		case(1):
		    number = "0000000".concat(number);
		    break;
		case(2):
		    number = "000000".concat(number);
		    break;
		case(3):
		    number = "00000".concat(number);
		    break;
		case(4):
		    number = "0000".concat(number);
		    break;
		case(5):
 ...
 public void encode(int[] data, PrintStream out) {
	int count = 0;
	String index;
	String number;
